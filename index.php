		...
		<header id="wm-header" class="wm-header-one">
			...
			<div class="wm-topstrip">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="wm-language"> <ul> <li><a href="#">English</a></li> <li><a href="#">Indonesia</a></li> </ul> </div>
                            <ul class="wm-stripinfo">
                                <li><i class="wmicon-location"></i> Jl. Aria Jaya Santika KM.4</li>
                                <li><i class="wmicon-technology4"></i> +62 8127736194</li>
                                <li><i class="wmicon-clock2"></i> Senin - Sabtu : 07:00 - 21:00</li>
                            </ul>
            ...
            <div class="wm-main-header">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3"><a href="index-2.html" class="wm-logo"><img src="images/logo-umbanten.png" alt=""></a></div>
                        <div class="col-md-9">
                            <!--// Navigation \\-->
                            <nav class="navbar navbar-default">
                                ...
                                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                  <ul class="nav navbar-nav">
                                    ...
                                    <li class="wm-megamenu-li"><a href="#">Alumni</a>
                            ...
                            <!--// Navigation \\-->
                            <a href="#" class="wm-header-btn">Penerimaan mahasiswa baru</a>
                        </div>
                    </div>
                </div>
            </div>
		...
		<div class="wm-main-banner">
            ...
            <div class="wm-banner-one">
                <div class="wm-banner-one-for">
                    <div class="wm-banner-one-for-layer"> <img src="extra-images/ppp.jpg" alt=""> </div>
